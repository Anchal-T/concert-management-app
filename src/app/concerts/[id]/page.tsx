          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="bg-[#0B101B]/50 border-border rounded-3xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {['Live', 'Music', 'Premium', 'Pro Lighting', 'Sold Out', 'Headliner', 'VIP Access', 'Nightlife', 'High Revenue'].map(tag => (
                  <Badge key={tag} className="bg-accent text-muted-foreground hover:bg-primary hover:text-white transition-all cursor-default px-3 py-1.5 rounded-xl border-border">
                    {tag}
                  </Badge>
                ))}
              </div>
              ...
              <div className="p-8 space-y-8 text-center sm:text-left">
                ...
                <div className="space-y-6">
                  <div className="p-6 rounded-3xl bg-accent/20 border border-border group-hover:bg-accent/30 transition-all">
                     ...
                     <p className="text-[10px] text-muted-foreground mt-2 font-bold uppercase tracking-widest">Target: 2,000</p>
                  </div>
                  ...
                  <div className="p-6 rounded-3xl bg-accent/20 border border-border group-hover:bg-accent/30 transition-all">
                     ...
                     <div className="text-4xl font-black">982</div>
                     <div className="flex items-center justify-center sm:justify-start -space-x-2 mt-4">
                        ...
                        <div className="w-7 h-7 rounded-full border-2 border-[#0B101B] bg-primary flex items-center justify-center text-[8px] font-black">+978</div>
                     </div>
                  </div>
                </div>
